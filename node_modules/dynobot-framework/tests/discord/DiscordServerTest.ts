...
describe("The class DiscordServer", function() {
	...
	describe("The method getChannels", function() {
		...
		it("Returns an array of wrapped channel objects", function() {
			...
			assert.strictEqual(Channels[0] instanceof DiscordChannel, true, "The first channel object was wrapped correctly.");
			assert.strictEqual(Channels[1] instanceof DiscordChannel, true, "The second channel object was wrapped correctly.");
		});
	});
	...
	describe("The method hasChannel", function() {
		...
		it("Returns the requested channel", function() {
			...
			//Assert
			assert.strictEqual(hasChannel instanceof DiscordChannel, true, "The channel exists and was returned.");
		});
	});
